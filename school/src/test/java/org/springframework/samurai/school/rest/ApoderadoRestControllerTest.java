...
import org.springframework.samurai.school.rest.ApoderadoRestController;
import org.springframework.samurai.school.rest.ExceptionControllerAdvice;
import org.springframework.samurai.school.service.ApoderadoService;
...
public class ApoderadoRestControllerTest {
	    ...
	    public void initApoderados(){
	    	...
	    	apoderado1.setId(1);
	        apoderado1.setNombre("Apoderado1");
	        apoderado1.setApellido("Apellido1");
	    	apoderados.add(apoderado1);
	    	
	    	apoderado2.setId(2);
	        apoderado2.setNombre("Apoderado2");
	        apoderado2.setApellido("Apellido2");
