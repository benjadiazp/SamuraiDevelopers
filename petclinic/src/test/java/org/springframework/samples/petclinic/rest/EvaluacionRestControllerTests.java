...
import org.springframework.samples.petclinic.service.EvaluacionService;
...
public class EvaluacionRestControllerTests {
	...
	public void initMensajes() {
		...
		this.mockMvc = MockMvcBuilders.standaloneSetup(evaluacionRestController).setControllerAdvice(new ExceptionControllerAdvice()).build();
    ...
    public void testGetAllEvaluacionNotFound() throws Exception {
	 ...
	 @Test
	    @WithMockUser(roles="OWNER_ADMIN")
	    public void testCreateEvaluacionesSuccess() throws Exception {
	    	...
	    	this.mockMvc.perform(post("/api/evaluaciones/")
	    		.content(newEvaluacionAsJSON).accept(MediaType.APPLICATION_JSON_VALUE).contentType(MediaType.APPLICATION_JSON_VALUE))
	 ...
	 @Test
	    ...
	    public void testCreateEvaluacionError() throws Exception {
	    	...
	    	ObjectMapper mapper = new ObjectMapper();
	    	String evaluacionErrorAsJSON = mapper.writeValueAsString(evaluacionError);
	    	this.mockMvc.perform(post("/api/evaluaciones/")
